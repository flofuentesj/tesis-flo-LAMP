...
\usepackage{subcaption} % FIXED: Changed from subfig to modern subcaption
\usepackage{pgfornament}
\usepackage[export]{adjustbox}
\usepackage{tikzlings}
\usepackage{fontawesome5} % FIXED: Added so \faExternalLink* and \faEnvelope work
...
% Header and footer
\pagestyle{fancy}
\fancyhead[C]{\includegraphics[width=0.05\textwidth]{images/escudo.png}}
...
% environment derived from framed.sty: see left bar environment definition
    ...
    \end{figure}
      ...
      \begin{minipage}{0.45\textwidth}
            ...
            \captionof{subfigure}{Waveform $I(D)$}
            \subcaption{Waveform $I(D)$}
            \label{fig:noise0}
      \end{minipage}
        \hfill
        \begin{minipage}{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{Images/noise0_fft.png}
            \captionof{subfigure}{FFT $I(D)$}
            \subcaption{FFT $I(D)$}
            \label{fig:noise0ftt}
        \end{minipage}
        \vspace{0.2cm}
        ...
        \begin{minipage}{0.45\textwidth}
            ...
            \captionof{subfigure}{Waveformy $I(D)$}
            \subcaption{Waveform $I(D)$}
            \label{fig:noise1}
        \end{minipage}
        \hfill
        \begin{minipage}{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{Images/noise1_fft.png}
            \captionof{subfigure}{FFT $I(D)$}
            \subcaption{FFT $I(D)$}
            \label{fig:noise1ftt}
        \end{minipage}
        ...
        \begin{minipage}{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{Images/noise1k.png}
            \captionof{subfigure}{Waveform $I(D)$}
            \subcaption{Waveform $I(D)$}
            \label{fig:noise1k}
        \end{minipage}
        ...
        \begin{minipage}{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{Images/noise1k_fft.png}
            \captionof{subfigure}{FFT $I(D)$}
            \subcaption{FFT $I(D)$}
            \label{fig:noise1kftt}
        \end{minipage}
